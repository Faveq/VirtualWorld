...
public class Constants {
    ...
    public static final String WOLF_GRAPHIC_REPRESENTATION = "W" ;
    ...
    public static final String TURTLE_GRAPHIC_REPRESENTATION = "T";
    ...
    public static final String ANTYLOPE_GRAPHIC_REPRESENTATION = "A";
    ...
    public static final String MILKWEED_GRAPHIC_REPRESENTATION = "*";
